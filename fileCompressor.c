...
int main(int argc,char *argv[])
{
    ...
    if(argc==4){
        ...
        puts("Cmd line argument format:\nto compress : [-] [input filepath] [compressed filepath]\nto compress : [+] [compressed filepath] [expanded filepath]");
    }
...
void compress(FILE *in,FILE *out)
{
    ...
    int number_of_bufbytes_to_compress,cur_byte_to_compress,write_bit_pos=0,read_bit_pos=0;
    ...
    do{
        ...
        {
            if(write_bit_pos==8) write_bit_pos=0;
